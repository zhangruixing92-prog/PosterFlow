...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      '/yhmx-api': {
        target: llm.image.baseUrl || 'https://yhmx.work',
        changeOrigin: true,
        rewrite: (path) => path.replace(/^\/yhmx-api/, ''),
      },
    },
  },
  define: {
    ...
    'import.meta.env.VITE_IMAGE_PROVIDER': JSON.stringify(llm.image.provider),
    ...
    'import.meta.env.VITE_IMAGE_BASE_URL': JSON.stringify(llm.image.baseUrl),
    'import.meta.env.VITE_IMAGE_API_KEY': JSON.stringify(llm.image.apiKey),
    'import.meta.env.VITE_IMAGE_GENERATION_ENDPOINT': JSON.stringify(llm.image.generationEndpoint),
    'import.meta.env.VITE_IMAGE_EDIT_ENDPOINT': JSON.stringify(llm.image.editEndpoint),
    'import.meta.env.VITE_IMAGE_RESOLUTION': JSON.stringify(llm.image.resolution),
